...
<html>
<head>
<title>Sam Carrelage : Sol extérieur</title>
...
<body>
	<div class="header">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
								...
								<li class="current"><a href="SolExt.php">Sol Exterieur</a></li>
	  ...
	  <?php
		include('db.php');
        $image_query = mysqli_query($connect,"select url_sol_ext, prix_sol_ext from sol_exterieur");
        while($rows = mysqli_fetch_array($image_query))
        {
            $img_prix = $rows['prix_sol_ext'];
            $img_src = $rows['url_sol_ext'];
        ?>
			<div class="main">
			<div class="shop_top">
				<div class="container">
