...
<html>
<head>
<title>Sam Carrelage : Sol intérieur</title>
...
<body>
	<div class="header">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
								...
								<li class="current"><a href="SolInt.php">Sol Interieur</a></li>
	  ...
	  <?php
		include('db.php');
        $image_query = mysqli_query($connect,"select url_sol_int, prix_sol_int from sol_interieur");
        while($rows = mysqli_fetch_array($image_query))
        {
            $img_prix = $rows['prix_sol_int'];
            $img_src = $rows['url_sol_int'];
        ?>
			<div class="main">
			<div class="shop_top">
				<div class="container">
